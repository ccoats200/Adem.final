...
//  Adem
//
//  Created by Coleman Coats on 11/9/20.
...
class halfwayController: UIPresentationController{
    ...
    override func presentationTransitionWillBegin() {
        ...
        self.presentedViewController.transitionCoordinator?.animate(alongsideTransition: { (UIViewControllerTransitionCoordinatorContext) in
            self.blurEffectView.alpha = 0.25
        }, completion: { (UIViewControllerTransitionCoordinatorContext) in
...
final class halfwayControllerTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {
    ...
    func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        return halfwayController(presentedViewController: presented, presenting: presented)
    }
