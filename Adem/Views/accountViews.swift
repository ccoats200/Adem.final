...
class ProfileView: UIView {
    ...
    func setupViews() {
        ...
        coverPhoto.heightAnchor.constraint(equalTo: self.heightAnchor, multiplier: 7/10), // width
        ...
        nameofUser.leadingAnchor.constraint(equalTo: self.leadingAnchor), // width
        nameofUser.trailingAnchor.constraint(equalTo: self.trailingAnchor),
